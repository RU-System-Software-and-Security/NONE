...
activation_function_global = None
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.relu = activation_function_global
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10,in_channels=3, activation_function=None):
        
        global activation_function_global
        
        if activation_function=="leakyrelu":
            activation_function_global = nn.LeakyReLU(inplace=True)
        elif activation_function=="elu":
            activation_function_global = nn.ELU(inplace=True)
        elif activation_function=="prelu":
            activation_function_global = nn.PReLU()
        elif activation_function=="tanhshrink":
            activation_function_global = nn.Tanhshrink()
        elif activation_function=="softplus":
            activation_function_global = nn.Softplus()
